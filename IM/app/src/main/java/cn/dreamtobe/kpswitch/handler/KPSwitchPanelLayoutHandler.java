...
public class KPSwitchPanelLayoutHandler implements IPanelConflictLayout {
    ...
    public boolean filterSetVisibility(final int visibility) {
        if(visibility == View.VISIBLE) {
            this.mIsHide = false;
            System.out.println("### PanelLayoutHandler: filterSetVisibility(): mIsHide = false;");
        }

        if(visibility == panelLayout.getVisibility()) {
            System.out.println("### PanelLayoutHandler: filterSetVisibility(): visibility == panelLayout.getVisibility(), return true;");
            return true;
        }
        ...
        if(isKeyboardShowing() && visibility == View.VISIBLE) {
            System.out.println("### PanelLayoutHandler: filterSetVisibility(): isKeyboardShowing() && visibility == View.VISIBLE, return true;");
            return true;
        }
    ...
    public int[] processOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if(mIsHide) {
            System.out.println("### PanelLayoutHandler: processOnMeasure(): mIsHide==true, panelLayout.setVisibility(View.GONE);");
    ...
    public void setIsKeyboardShowing(final boolean isKeyboardShowing) {
        ...
        System.out.println("### PanelLayoutHandler: setIsKeyboardShowing(): " + isKeyboardShowing);
    }
    ...
    public void handleHide() {
        this.mIsHide = true;
        System.out.println("### PanelLayoutHandler: handleHide(): " + mIsHide);
    }
