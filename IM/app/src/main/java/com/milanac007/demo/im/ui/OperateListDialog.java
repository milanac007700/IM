...
public class OperateListDialog {
    ...
    private void init(Context context){
        mContext = context;
        widthPixels = CommonFunction.getWidthPx();
    ...
    public void setItemCount(int count){
        if(showTitle){
            ...
            mOperateDialog.setBackground(R.color.white);
        }
    ...
    private class OperateDialog extends Dialog {
        ...
        public void refreshWindow(){
            ...
            int maxHeightInPx = CommonFunction.getHeightPx()*6/10;
            int dialogHeightInPx = CommonFunction.dip2px(mDialogHeightInDp);
